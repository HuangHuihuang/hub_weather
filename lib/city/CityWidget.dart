...
import 'package:hub_weather/city/CityData.dart';
import 'package:hub_weather/weather/WeatherWidget.dart';
...
class CityState extends State<CityWidget>{
  ...
  Future<List<CityData>> _fetchCityList() async{
    final response = await http.get('https://search.heweather.net/top?group=cn&key=3fb30b0312ab4493a7d77ccfeb0d6a4e');
